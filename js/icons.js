// ============================================
// SVG ICONS LIBRARY - UPDATED VERSION
// ============================================
...
const icons = {
    ...
    // NEW IMPROVED Book icon for study decks
    book: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // Reshuffle icon
    shuffle: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // NEW IMPROVED Expand sidebar icon
    expand: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M10 6H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h5"></path>
        <polyline points="14 12 18 8 14 4"></polyline>
        <polyline points="14 20 18 16 14 12"></polyline>
    </svg>`,
    
    // NEW IMPROVED Collapse sidebar icon
    collapse: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M14 6h5a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-5"></path>
        <polyline points="10 12 6 8 10 4"></polyline>
        <polyline points="10 20 6 16 10 12"></polyline>
    </svg>`,
    ...
    // Key icon
    key: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    // List icon
    list: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    selectDeck: `<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
    <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
    <line x1="12" y1="7" x2="12" y2="21"></line>
...
// ADD THESE to your icons object:
    ...
    // Resources/grid icon
    resources: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
